  ...
  var functionalDescriptor = function(proto, propName) {
    ...
    return Coral.commons.extend({}, descriptor, {
      ...
      set: function(value) {
        ...
        if (insert) {
          // Remove old node
          var oldNode = this._elements[handle];
          ...
          if (this._elements[handle] && this._elements[handle].parentNode) {
  ...
  Coral.Component.prototype.createdCallback = function() {
    ...
    for (prop in this._properties) {
      ...
      if (descriptor.contentZone) {
        // Add the prop to a list
        this._contentZones.push(prop);
      }
      ...
      if (record.type === 'childList') {
        ...
        Array.prototype.forEach.call(record.addedNodes, function(node) {
          ...
          if (node.nodeType === Node.ELEMENT_NODE) {
            ...
            // Check if the added node matches a content zone
            for (var i = 0; i < self._contentZones.length; i++) {
              var property = self._contentZones[i];
              if (self._properties[property].tagName === tagName) {
                // Assign to content zone
                self[self._properties[property].handle] = node;
                break;
              }
            }
          }
...
(function() {
  ...
  Coral.register( /** @lends Coral.Shell.Content */ {
    /**
      @class Coral.Shell.Content
      @classdesc The shell content component
      @extends Coral.Component
      @htmltag coral-shell-content
    */
    name: 'Shell.Content',
    tagName: 'coral-shell-content',
    className: 'coral-Shell-content'
  });
}());
  ...
  Coral.register( /** @lends Coral.Button# */ {
      ...
      */
      'iconSize': {
        ...
        get: function() {
          var iconElement = this._elements.icon;
          if (iconElement) {
            return iconElement.size;
          }
          else {
            return Coral.Icon.size.SMALL;
          }
        },
        set: function(value) {
    ...
    */
    _toggleSquare: function() {
      ...
      this.classList.toggle(this._className + '--square', isSquare);
    },
...
(function() {
  ...
  Coral.register( /** @lends Coral.Shell.Header */ {
    ...
    */
    ...
    _initialize: function() {
      ...
      this.$.addClass('coral--dark');
    }
  });

  Coral.register( /** @lends Coral.Shell.Header.Home */ {
    /**
      @class Coral.Shell.Header.Home
      @classdesc The Shell.Header's home content component
      @extends Coral.Component
      @htmltag coral-shell-header-home
    */
    name: 'Shell.Header.Home',
    tagName: 'coral-shell-header-home',
    className: 'coral-Shell-header-home',
  ...
  Coral.register( /** @lends Coral.Shell.Header.Actions */ {
    /**
      @class Coral.Shell.Header.Actions
      @classdesc A Shell.Header Actions component
      @extends Coral.Component
      @htmltag coral-shell-header-actions
    */
    name: 'Shell.Header.Actions',
    tagName: 'coral-shell-header-actions',
    className: 'coral-Shell-header-actions'
  });

  Coral.register( /** @lends Coral.Shell.Header.Content */ {
    /**
      @class Coral.Shell.Header.Content
      @classdesc A Shell.Header Content component
      @extends Coral.Component
      @htmltag coral-shell-header-content
    */
    name: 'Shell.Header.Content',
    tagName: 'coral-shell-header-content',
    className: 'coral-Shell-header-content'
  });
}());
...
(function() {
  ...
  Coral.register( /** @lends Coral.Shell.HomeAnchor */ {
    ...
    */
    ...
    className: 'coral-Shell-homeAnchor',
    ...
    _render: function() {
      ...
      if (!this._elements.icon) {
        ...
        this._elements.icon.className += ' coral-Shell-homeAnchor-icon';
      }
  ...
  Coral.register( /** lends Coral.Shell.HomeAnchor.Label# */ {
    /**
      ...
      @extends Coral.Component
    */
    name: 'Shell.HomeAnchor.Label',
    tagName: 'coral-shell-homeanchor-label',
    className: 'coral-Shell-homeAnchor-label'
  });
}());
...
(function() {
  ...
  /**
    ...
    @param {String} [options.itemSelector]
      Optional, derived from itemTagName and itemBaseTagName by default. Used to query the host element for its collection
      items.
  ...
  */
  ...
  Coral.Collection.prototype.getAll = function() {
    ...
    if (this._container && this._itemSelector) {
      var items = Array.prototype.slice.call(this._container.querySelectorAll(this._itemSelector));
      if (this._filter) {
...
(function() {
  ...
  */
  Coral.SelectableCollection.prototype._getAllSelected = function(selectedAttribute) {
    ...
    return Array.prototype.slice.call(this._host.querySelectorAll(selector));
  };
...
(function() {
  ...
  Coral.register( /** @lends Coral.Shell.Workspaces */ {
    ...
    */
    ...
    className: 'coral-Shell-workspaces',
  ...
  Coral.register( /** @lends Coral.Shell.Workspace */ {
    ...
    */
    ...
    className: 'coral-Shell-workspaces-workspace',
    baseTagName: 'a',
...
/**/) {
  ...
  el0.className += " coral-Shell-solution-icon";
  return el0;
});
/*
 * ADOBE CONFIDENTIAL
...
(function() {
  ...
  Coral.register( /** @lends Coral.Shell.SolutionSwitcher */ {
    ...
    */
    ...
    className: 'coral-Shell-solutionSwitcher',

    properties: {
      /**
        The main content zone for this component.

        @type {HTMLElement}
        @contentzone
        @memberof Coral.Shell.SolutionSwitcher#
      */
      'content': Coral.property.contentZone({
        handle: 'content',
        tagName: 'coral-Shell-solutionswitcher-content'
      })
    },
    ...
    _render: function() {
      ...
      var content = this._elements.content = this.querySelector('coral-shell-solutionswitcher-content') ||
        document.createElement('coral-shell-solutionswitcher-content');
      frag.appendChild(content);

      // Create the solutions container if not already present
      var container = this._elements.solutionsContainer = document.createElement('div');
      container.className += ' coral-Shell-solutions-container';
      content.appendChild(container);

      // Move linked and unlinked solutions into container
      this.$.find('coral-shell-solutions:not([secondary])').appendTo(container);

      // Move everything else into content
      while (this.firstChild) {
        content.appendChild(this.firstChild);
      }
      ...
      if (window.navigator.userAgent.indexOf('MSIE 9.0') !== -1 ||
          window.navigator.userAgent.indexOf('MSIE 10.0') !== -1) {
        this.$.addClass(this._className + '--IE');
      }
    }
  });

  Coral.register( /** @lends Coral.Shell.SolutionSwitcher.Content */ {
    /**
      @class Coral.Shell.SolutionSwitcher.Content
      @classdesc A Shell.SolutionSwitcher Content component
      @extends Coral.Component
      @htmltag coral-shell-solutionswitcher-content
    */
    name: 'Shell.SolutionSwitcher.Content',
    tagName: 'coral-shell-solutionswitcher-content',
    className: 'coral-Shell-solutionSwitcher-content'
  });
    ...
    properties: {
      ...
      */
      'secondary': {
        ...
        attributeTransform: Coral.transform.booleanAttr,
        sync: function() {
          this.$.toggleClass(this._className + '--secondary', this.secondary);
        }
      }
    }
  });
  ...
  Coral.register( /** @lends Coral.Shell.Solution */ {
    ...
    */
    ...
    className: 'coral-Shell-solution',
    baseTagName: 'a',
    extend: HTMLAnchorElement,
    ...
    properties: {
      ...
      */
      'linked': {
        ...
        attributeTransform: Coral.transform.booleanAttr,
        sync: function() {
          this.$.toggleClass(this._className + '--linked', this.linked);
        }
      }
    },
  ...
  Coral.register( /** @lends Coral.Shell.Solution.Label */ {
    /**
      @class Coral.Shell.Solution.Label
      @classdesc The Shell's solution label
      @extends Coral.Component
      @htmltag coral-shell-solution-label
    */
    name: 'Shell.Solution.Label',
    tagName: 'coral-shell-solution-label',
    className: 'coral-Shell-solution-label'
  });
}());
    ...
    */
    _focusOn: function(which) {
      ...
      if (which === 'first' || which === 'last') {
        tabTarget = this.$.find(':tabbable').not('[coral-tabcapture]')[which]();
        if (tabTarget.length) {
          tabTarget.focus();
        }
      }
...
/**/) {
  ...
  el0.className += " coral-Shell-menu-button";
    ...
    */
    ...
    properties: {
      ...
      */
      'iconVariant': {
        ...
        sync: function() {
          ...
          this.$.removeClass(ALL_ICONVARIANT_CLASSES);
          // adds the new variant
          if (this.variant !== Coral.Shell.MenuBar.Item.iconVariant.DEFAULT) {
            this.$.addClass(CLASSNAME + '--' + this.iconVariant);
          }
        }
      },
      ...
      */
      'label': {
        set: function(value) {
          this._elements.shellMenuButton.label = value;
        },
        get: function() {
          return this._elements.shellMenuButton.label;
        }
      },
...
(function() {
  ...
  var CLASSNAME = 'coral-Shell-menu';
  ...
  */
  ...
  for (var placementValue in placement) {
    ALL_PLACEMENT_CLASSES += CLASSNAME + '--' + placement[placementValue] + ' ';
  }
  ...
  */
  ...
  for (var fromValue in from) {
    ALL_FROM_CLASSES += CLASSNAME + '--' + from[fromValue] + ' ';
  }
  ...
  Coral.register( /** @lends Coral.Shell.Menu# */ {
    ...
    properties: {
      ...
      */
      'placement': {
        ...
        sync: function() {
          this.$.removeClass(ALL_PLACEMENT_CLASSES);
          this.$.addClass(this._className + '--placement-' + this.placement);
        }
      },
      ...
      */
      'from': {
        ...
        sync: function() {
          this.$.removeClass(ALL_FROM_CLASSES);
          this.$.addClass(this._className + '--from-' + this.from);
        }
      },
      ...
      */
      'full': {
        ...
        attributeTransform: Coral.transform.booleanAttr,
        sync: function() {
          this.$.toggleClass(this._className + '--full', this.full);
        }
      },
    ...
    */
    _handleGlobalClick: function(event) {
      ...
      var item = $(eventTarget).closest('coral-shell-menubar-item').get(0);
...
(function() {
  ...
  */
  ...
  Coral.register( /** @lends Coral.Shell.User.Name */ {
    /**
      @class Coral.Shell.User.Name
      @classdesc The shell user component's name content zone
      @extends Coral.Component
      @htmltag coral-shell-user-name
    */
    name: 'Shell.User.Name',
    tagName: 'coral-shell-user-name',
    className: 'coral-Shell-user-name'
  });

  Coral.register( /** @lends Coral.Shell.User.Heading */ {
    /**
      @class Coral.Shell.User.Heading
      @classdesc The shell user component's heading content zone
      @extends Coral.Component
      @htmltag coral-shell-user-heading
    */
    name: 'Shell.User.Heading',
    tagName: 'coral-shell-user-heading',
    className: 'coral-Shell-user-heading'
  });

  Coral.register( /** @lends Coral.Shell.User.Subheading */ {
    /**
      @class Coral.Shell.User.Subheading
      @classdesc The shell user component's subheading content zone
      @extends Coral.Component
      @htmltag coral-shell-user-subheading
    */
    name: 'Shell.User.Subheading',
    tagName: 'coral-shell-user-subheading',
    className: 'coral-Shell-user-subheading'
  });

  Coral.register( /** @lends Coral.Shell.User.Content */ {
    /**
      @class Coral.Shell.User.Content
      @classdesc The shell user component's main content zone
      @extends Coral.Component
      @htmltag coral-shell-user-content
    */
    name: 'Shell.User.Content',
    tagName: 'coral-shell-user-content',
    className: 'coral-Shell-user-content'
  });

  Coral.register( /** @lends Coral.Shell.User.Footer */ {
    /**
      @class Coral.Shell.User.Footer
      @classdesc The shell user component's footer content zone
      @extends Coral.Component
      @htmltag coral-shell-user-footer
    */
    name: 'Shell.User.Footer',
    tagName: 'coral-shell-user-footer',
    className: 'coral-Shell-user-footer'
  });
...
window["Coral"]["strings"]["coralui-component-search"] = {"it-IT":{"Clear search":"Azzera ricerca"},"ja-JP":{"Clear search":"検索をクリア"},"es-ES":{"Clear search":"Borrar búsqueda"},"ko-KR":{"Clear search":"검색 지우기"},"zh-CN":{"Clear search":"清除搜索"},"zh-TW":{"Clear search":"清除搜尋"},"pt-BR":{"Clear search":"Limpar busca"},"en-US":{"Clear search":"Clear search"},"de-DE":{"Clear search":"Suche löschen"},"fr-FR":{"Clear search":"Effacer la recherche"}};
window["Coral"] = window["Coral"] || {};
window["Coral"]["templates"] = window["Coral"]["templates"] || {};
...
/**/) {
  ...
  el5.setAttribute("aria-label", Coral["i18n"]["get"]('Clear search'));
  ...
  Coral.register( /** lends Coral.Wait# */ {
    ...
    */
      ...
      */
      'size': {
        ...
        set: function(value) {
          ...
          // medium css change
          this.$[this.size === size.MEDIUM ? 'addClass' : 'removeClass'](this._className + '--medium');
        }
      },
    ...
    _render: function() {
      // @polyfill ie9
      if (window.navigator.userAgent.indexOf('MSIE 9.0') !== -1) {
        this.$.addClass(this._className + '--IE9');
      }
    },
  });
...
window["Coral"] = window["Coral"] || {};
window["Coral"]["strings"] = window["Coral"]["strings"] || {};
window["Coral"]["strings"]["coralui-component-shell-help"] = {"en-US":{"Search for Help":"Search for Help","Searching Help…":"Searching Help…","Error fetching results&period;":"Error fetching results.","No results found":"No results found","See all {0} results":"See all {0} results"},"fr-FR":{"Search for Help":"Rechercher de l’aide","Searching Help…":"Recherche dans l’aide…","Error fetching results&period;":"Erreur lors de la récupération des résultats.","No results found":"Aucun résultat trouvé","See all {0} results":"Voir l'ensemble des {0} résultats"},"de-DE":{"Search for Help":"Nach Hilfe suchen","Searching Help…":"Suche nach Hilfe …","Error fetching results&period;":"Fehler beim Abruf von Ergebnissen.","No results found":"Keine Ergebnisse gefunden","See all {0} results":"Zeige alle {0} Ergebnisse"},"it-IT":{"Search for Help":"Cerca informazioni nell'Aiuto","Searching Help…":"Ricerca aiuto…","Error fetching results&period;":"Errore nel recupero dei risultati.","No results found":"Nessun risultato trovato","See all {0} results":"Vedi tutti i risultati {0}"},"es-ES":{"Search for Help":"Buscar ayuda","Searching Help…":"Buscando ayuda…","Error fetching results&period;":"Error al obtener los resultados.","No results found":"No se han encontrado resultados","See all {0} results":"Ver todos los {0} resultados"},"pt-BR":{"Search for Help":"Procurar nas seções de Ajuda","Searching Help…":"Pesquisando ajuda…","Error fetching results&period;":"Erro ao buscar resultados.","No results found":"Nenhum resultado encontrado","See all {0} results":"Ver todos os {0} resultados"},"ja-JP":{"Search for Help":"ヘルプを検索","Searching Help…":"ヘルプを検索中…","Error fetching results&period;":"結果を取得中にエラーが発生しました。","No results found":"結果が見つかりませんでした","See all {0} results":"{0}件の検索結果を全て見る"},"ko-KR":{"Search for Help":"도움말 검색","Searching Help…":"도움말 검색 중…","Error fetching results&period;":"결과를 가져오는 중 오류 발생.","No results found":"결과를 찾을 수 없습니다.","See all {0} results":"{0}건 모두 보기"},"zh-CN":{"Search for Help":"搜索帮助","Searching Help…":"正在搜索帮助…","Error fetching results&period;":"获取结果时出错。","No results found":"找不到任何结果","See all {0} results":"查看所有的 {0} 结果"},"zh-TW":{"Search for Help":"搜尋說明","Searching Help…":"正在搜尋說明...","Error fetching results&period;":"擷取結果時發生錯誤。","No results found":"找不到結果","See all {0} results":"查看所有 {0} 項結果"}};
window["Coral"] = window["Coral"] || {};
window["Coral"]["templates"] = window["Coral"]["templates"] || {};
window["Coral"]["templates"]["Shell"] = window["Coral"]["templates"]["Shell"] || {};
...
var labelId = Coral.commons.getUID();
  ...
  el4.className += " coral-Shell-help-search";
  ...
  el6.className += " coral-Shell-help-items";
  ...
  el8.className += " coral-Shell-help-results";
  ...
  el10.className += " coral-Shell-help-resultMessage";
  ...
  el12.className += " coral-Shell-help-loading";
...
/**/) {
  ...
  el2.className += " coral-Shell-help-result-description";
...
/**/) {
  ...
  el0.className += " coral-Shell-help-resultMessage-container";
  var el1 = document.createTextNode("\n  ");
  el0.appendChild(el1);
  var el2 = document.createElement("div");
  el2.className += " coral-Heading--1 coral-Shell-help-resultMessage-heading";
...
(function() {
  ...
  Coral.register( /** @lends Coral.Shell.Help */ {
    ...
    */
    ...
    className: 'coral-BasicList coral-AnchorList coral-Shell-help',
    ...
    /** @private */
    _moveItems: function() {
      this.$.find('> a[is="coral-shell-help-item"]').appendTo(this._elements.items);
    },
    ...
    showResults: function(results, total, allResultsURL) {
      ...
      if (!results || total === 0) {
        ...
        if (total > 1) {
          ...
          seeAllItem.$.addClass('coral-Link coral-Shell-help-allResults');
  ...
  Coral.register( /** @lends Coral.Shell.Help.Item */ {
    ...
    */
    ...
    className: 'coral-BasicList-item coral-AnchorList-item coral-Shell-help-item',
    baseTagName: 'a',
...
var labelId = Coral.commons.getUID();
  ...
  frag.appendChild(el3);
  var el4 = this["search"] = document.createElement("coral-search");
  el4.className += " coral-Shell-orgSwitcher-search";
  ...
  frag.appendChild(el5);
  var el6 = this["items"] = document.createElement("div");
  el6.className += " coral-Shell-orgSwitcher-items";
  el6.setAttribute("handle", "items");
  frag.appendChild(el6);
  var el7 = document.createTextNode("\n");
  frag.appendChild(el7);
  var el8 = this["resultMessage"] = document.createElement("div");
  el8.className += " coral-Shell-orgSwitcher-resultMessage";
  el8.setAttribute("handle", "resultMessage");
  el8.setAttribute("hidden", "");
  var el9 = document.createTextNode("\n  ");
  el8.appendChild(el9);
  var el10 = document.createElement("div");
  el10.className += " coral-Shell-orgSwitcher-resultMessage-container";
  var el11 = document.createTextNode("\n    ");
  el10.appendChild(el11);
  var el12 = document.createElement("div");
  el12.className += " coral-Heading--1 coral-Shell-orgSwitcher-resultMessage-heading";
  ...
  */
  ...
  Coral.register( /** @lends Coral.Shell.OrgSwitcher */ {
    ...
    */
    ...
    className: 'coral-BasicList coral-Shell-orgSwitcher',
    extend: Coral.List,
    ...
    /** @private */
    _moveItems: function() {
      this.$.find('> coral-shell-organization').appendTo(this._elements.items);
    }
  ...
  Coral.register( /** @lends Coral.Shell.Organization */ {
    ...
    */
    ...
    className: 'coral-BasicList-item coral-Shell-orgSwitcher-item',
    extend: Coral.List.Item,
      ...
      'selected': {
        ...
        set: function(selected) {
          ...
          if (this.items) {
            ...
            this.$.toggleClass('is-child-selected', childIsSelected);
    ...
    _render: function() {
      ...
      checkmark.$.addClass('coral-Shell-orgSwitcher-item-checkmark');
      this.appendChild(checkmark);

      var items = this._elements.items = document.createElement('div');
      items.className = 'coral-Shell-orgSwitcher-subitems';
      this.appendChild(items);

      // Set the icon size
      this._elements.icon.size = 'M';
      // Add the className, owned by this component
      this._elements.icon.className += ' coral-Shell-orgSwitcher-item-icon';
    ...
    _setParentness: function() {
      ...
      this.$.toggleClass('is-parent', hasChildren);
    },
    ...
    /** @private */
    _moveItems: function() {
      this.$.find('coral-shell-suborganization').appendTo(this._elements.items);
    }
  ...
  Coral.register( /** @lends Coral.Shell.Suborganization */ {
    ...
    */
    ...
    className: 'coral-BasicList-item coral-Shell-orgSwitcher-subitem',
    ...
    _render: function() {
      ...
      // Add the className, owned by this component
      this._elements.icon.className += ' coral-Shell-orgSwitcher-subitem-icon';
  ...
  Coral.register( /** @lends Coral.Shell.OrgSwitcher.Footer */ {
    /**
      @class Coral.Shell.OrgSwitcher.Footer
      @classdesc The shell orgswitcher component's footer content zone
      @extends Coral.Component
      @htmltag coral-shell-orgswitcher-footer
    */
    name: 'Shell.OrgSwitcher.Footer',
    tagName: 'coral-shell-orgswitcher-footer',
    className: 'coral-Shell-orgSwitcher-footer'
  });
}());

...
class Core(object):
    ...
    def __init__(self, inPath,core = '35'):
        ...
        self.patient.show()
        marks.write.csv("file:///home/zcjin/Data_event_anomaly_sub")
        result.write.csv("file:///home/zcjin/Data_connect_anomaly_sub")
        self.patient.write.csv("file:///home/zcjin/Data_patient_anomaly_sub")
